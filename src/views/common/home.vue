<template>
  <div class="mod-home">
    <!--<h3>项目介绍</h3>-->
    <!--<ul>-->
      <!--<li>茄籽TV基于vue、element-ui构建开发，实现<a href="https://gitee.com/renrenio/QieZi-TV" target="_blank">QieZi-TV</a>后台管理前端功能，提供一套更优的前端解决方案</li>-->
    ...
    <!--<ul>-->
      ...
      <!--<li>前端Git地址：<a href="//github.com/daxiongYang/茄籽TV" target="_blank">github.com/daxiongYang/茄籽TV</a></li>-->
      <!--<li>后台Git地址：<a href="//git.oschina.net/renrenio/QieZi-TV" target="_blank">git.schina.net/renrenio/QieZi-TV</a></li>-->
