  ...
  <div>
    <el-dialog
      ...
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
        ...
        <el-form-item type="number" label="每天允许投票次数" prop="times">
          <el-input v-model="dataForm.times" placeholder=""></el-input>
        </el-form-item>
        <el-form-item type="number" label="微信每天投票次数" prop="weixinTimes">
          <el-input v-model="dataForm.weixinTimes" placeholder=""></el-input>
        </el-form-item>
        <el-form-item type="number" label="APP每天投票次数" prop="appTimes">
          <el-input v-model="dataForm.appTimes" placeholder=""></el-input>
        </el-form-item>
      </el-form>
